...
var SmartForm = ({
  ...
  const renderField = useCallback2(
    (field) => {
      ...
      switch (field.type) {
        case "text":
          fieldEl = /* @__PURE__ */ jsx7(TextField_default, __spreadValues({}, commonProps));
          break;
        case "email":
          fieldEl = /* @__PURE__ */ jsx7(TextField_default, __spreadProps(__spreadValues({}, commonProps), { type: "email" }));
          break;
        case "password":
          fieldEl = /* @__PURE__ */ jsx7(TextField_default, __spreadProps(__spreadValues({}, commonProps), { type: "password" }));
          break;
        case "date":
          fieldEl = /* @__PURE__ */ jsx7(TextField_default, __spreadProps(__spreadValues({}, commonProps), { type: "date" }));
          break;
        case "number":
          fieldEl = /* @__PURE__ */ jsx7(NumberField_default, __spreadValues({}, commonProps));
          break;
        case "textarea":
          fieldEl = /* @__PURE__ */ jsx7(TextAreaField_default, __spreadProps(__spreadValues({}, commonProps), { rows: field.rows }));
          break;
        case "select":
          fieldEl = /* @__PURE__ */ jsx7(
            SelectField_default,
          ...
          break;
        case "radio":
          fieldEl = /* @__PURE__ */ jsx7(RadioField_default, __spreadProps(__spreadValues({}, commonProps), { options: field.options }));
          break;
        case "checkbox":
          fieldEl = /* @__PURE__ */ jsx7(CheckboxField_default, __spreadValues({}, commonProps));
          break;
        default:
          fieldEl = /* @__PURE__ */ jsx7(TextField_default, __spreadValues({}, commonProps));
      }
      return /* @__PURE__ */ jsx7("div", { className: "sf-field-wrapper", style: colStyle, children: fieldEl }, field.name);
    },
  ...
  return /* @__PURE__ */ jsxs7(
    "form",
    {
      ...
      children: [
        /* @__PURE__ */ jsx7("div", { className: "sf-grid", children: schema.map(renderField) }),
        /* @__PURE__ */ jsxs7("div", { className: "sf-actions", children: [
          /* @__PURE__ */ jsx7(
            "button",
            {
              type: "submit",
